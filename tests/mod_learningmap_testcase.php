...
/**
 * Test class with common test methods for mod_progresspath
 *
 ...
 */
abstract class mod_progresspath_testcase extends \advanced_testcase {
    /**
    ...
    public function prepare($completiontype, $groupmode = false, $passinggrade = false): void {
        ...
        // Set up the progresspath for this test.
        $this->progresspath = $this->getDataGenerator()->create_module(
            'progresspath',
