...
global $CFG;
require_once($CFG->dirroot . '/mod/progresspath/tests/mod_progresspath_testcase.php');
 ...
 * @group      mebis
 * @covers     \mod_progresspath\activitymanager
 */
final class mod_progresspath_activitymanager_test extends mod_progresspath_testcase {
    /**
