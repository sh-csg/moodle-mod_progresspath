 ...
 * As soon as the support is being dropped, this can be removed as well as the call in lib.php::progresspath_cm_info_view
 *
 * @param {array} coursemodules course modules the progresspath depends on
 */
