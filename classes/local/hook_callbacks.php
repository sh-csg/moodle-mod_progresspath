...
/**
 * Hook callbacks for mod_progresspath.
 *
...
namespace mod_progresspath\local;
...
class hook_callbacks {
     ...
     *
     * This function takes care of injecting the backlinks into an activity page header, if the activity belongs to a progresspath
     * and the progresspath has the backlink feature enabled.
     *
        ...
        try {
            ...
            foreach ($backlinks as $backlink) {
                ...
                if ($cminfo->available != 0 && $cminfo->uservisible) {
                    $backlinktext .= $beforehttpheadershook->renderer->render_from_template('progresspath/backtomap', $backlink);
                }
            }
